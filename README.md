...
ZCACHE="$HOME/.zcode/cli/plugins/cache/zcode-plugins-official/zcode-codex-leader/0.3.0"
mkdir -p "$ZCACHE"
...
const e={cachePath:process.env.HOME+"/.zcode/cli/plugins/cache/zcode-plugins-official/zcode-codex-leader/0.3.0",name:"zcode-codex-leader",source:"filesystem",version:"0.3.0"};
